        ...
        <tr>
          <td align="center">
            ...
            <div style="font-size: 16px; line-height: 1.6; color: #444444; text-align: left; padding: 0 15px;">
              ...
              <p>
                धर्म रक्षा और सेवा के इस पुनीत अभियान में स्वेच्छा से जुड़ने के लिए <b>हम हृदय से आपके आभारी हैं</b>।
              </p>
              <p>
                आपका यह समर्पित सहयोग, सनातन धर्म और राष्ट्र की सेवा के हमारे सामूहिक लक्ष्य को एक नई दिशा और <b>अभूतपूर्व बल</b> प्रदान करता है। हम संगठन में आपके सक्रिय योगदान की प्रतीक्षा कर रहे हैं।
              </p>
            </div>
            ...
            <div style="background-color: #ffecb3; padding: 15px; border-radius: 8px; margin: 25px 15px; border-left: 4px solid #d32f2f; text-align: center;">
              <h3 style="margin: 0; font-size: 18px; color: #b71c1c; font-weight: bold;">
                राष्ट्र सेवा ही सबसे बड़ा धर्म है।
              </h3>
            </div>
